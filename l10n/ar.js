OC.L10N.register(
    ...
    "Allows administrators to write small scripts which users can run through via the file actions menu in the Files app!\n\n- **🌕 Lua:** Script in Lua, its simple and has plenty of online resources.\n- **⚡️Empower users:** Make hard tasks easy, straight from the Files app.\n- **🙋 Open to suggestions:** Are you missing a function in the scripting API? Open an issue on Github!\n- **🤖 Integration with Nextcloud Flow:** allows you to fully automate workflows\n\n⚠️**Attention** Scripts may modify and delete files permanently. Take care and make sure to read the documentation thoroughly before scripting." : "يسمح للمشرفين بكتابة نصوص برمجية صغيرة يمكن للمستخدمين تشغيلها من خلال قائمة إجراءات الملفات في تطبيق الملفات! \n- ** 🌕 Lua: ** برنامج نصي بلغة Lua  البسيطة، و التي يتوافر لها الكثير من الموارد عبر الإنترنت \n- ** ⚡️ تمكين المستخدمين: ** اجعل المهام الصعبة سهلة ، مباشرة من تطبيق الملفات \n- ** 🙋 مفتوحة أمام الاقتراحات: ** هل تفتقد وظيفة في واجهة برمجة تطبيقات البرمجة النصية؟ إفتح تذكرة على GitHub! \n- ** 🤖 التكامل مع Nextcloud Flow: ** يسمح لك بأتمتة مسارات الدَّفق بالكامل \n\n⚠️ ** انتباه ** البرامج النصية scripts قد تعدل وتحذف الملفات بشكل دائم. كن حذرًا وتأكد من قراءة الوثائق جيدًا قبل البرمجة النصية.",
