OC.L10N.register(
    ...
    "Specify any number of input values which the user may provide when running this action. These will be accessible in the script via the get_input() function." : "Spécifier n’importe quel nombre de valeurs d’entrée que l’utilisateur peut fournir lors de l’exécution de cette action. Elles seront accessibles dans le script via la fonction get_input().",
    ...
    "No file actions exist." : "Aucun fichier d'action n'existe",
    ...
    "MIME type (e.g. text/plain)" : "Type MIME (ex. text/plain)",
