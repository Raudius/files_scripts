OC.L10N.register(
    ...
    "Large textarea" : "Grand champ texte",
    ...
    "MIME type (e.g. plain/text)" : "Type MIME (ex. plain/text)",
    "Saved" : "Enregistré",
    ...
    "Allows administrators to write small scripts which users can run through via the file actions menu in the Files app!\n\n- **🌕 Lua:** Script in Lua, its simple and has plenty of online resources.\n- **⚡️Empower users:** Make hard tasks easy, straight from the Files app.\n- **🙋 Open to suggestions:** Are you missing a function in the scripting API? Open an issue on Github!\n\n\n⚠️**Attention** This app requires additional configuration, and may not be suitable for all users. Make sure to read the documentation thoroughly.\n\n⚠️**Attention** With great power comes great responsibility: Scripts may modify and delete files permanently. Make sure to read the documentation thoroughly before scripting." : "Permet aux administrateurs d’écrire de petits scripts que les utilisateurs peuvent exécuter via le menu des actions de fichier dans l'application Fichers !\n\n\n- **🌕 Lua:** Script en langage Lua, simple et offre de nombreuses ressources en ligne.\n- **⚡️ Habiliter les utilisateurs :** Faciliter les tâches difficiles, directement à partir de l’application Fichiers. - **🙋 Ouvert aux suggestions :** Une fonction vous manque dans l’API de script ? Ouvrez un ticket sur Github !\n\n\n⚠️**Attention** Cette application nécessite une configuration supplémentaire et peut ne pas convenir à tous les utilisateurs. Assurez-vous de lire attentivement la documentation.\n\n⚠️**Attention** Avec une grande puissance vient une grande responsabilité : Les scripts peuvent modifier et supprimer des fichiers de façon permanente. Assurez-vous de lire attentivement la documentation avant de rédiger un script.",
    "User prompt …" : "Invite utilisateur…",
    "Request target folder" : "Demander le dossier cible",
