OC.L10N.register(
    ...
    "Limit by file types" : "Limit by file types",
    "Media type or file extension (e.g. text/plain, doc)" : "Media type or file extension (e.g. text/plain, doc)",
    "Saved" : "Saved",
    ...
    "File actions are small Lua scripts that can create, modify, and/or delete files programmatically. These actions may be triggered by users to run on their files. Please read the documentation for more information." : "File actions are small Lua scripts that can create, modify, and/or delete files programmatically. These actions may be triggered by users to run on their files. Please read the documentation for more information.",
